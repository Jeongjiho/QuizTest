...
<body>
  ...
  <div align="right" style="margin-right:200px; margin-top:50px">
<jsp:include page="/Header.jsp" />
</div> 
  <div class="pen-title">
  ...
  <div class='column'>
    <div class='post-module'>
      <div class='thumbnail'>
        ...
        <a href='detail.do?no=${board.no}'><img style="align:center;"src="../file/${(empty board.photo)?"1.jpeg":board.photo}"></a>
      </div>
