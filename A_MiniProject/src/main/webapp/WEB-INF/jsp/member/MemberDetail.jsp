	...
	<div class="container">
		...
		<div class="card">
			<form id='form1' action='update.do' method='post'
				...
				<div class="input-container">
					<input type="password" name='pwd' required="required"> <label
				...
				<div class="input-container">
					<td><input type='text' name='address'
						value='${member.address}'></td> <label for="address">Address</label>
					<div class="bar"></div>
				</div>
				...
				<div style="margin-left: 4px">
					<img width='200' height='300'
						src='../file/${(empty member.photo)?"1.jpeg":member.photo}'>
				</div>
				<br>
				<br>
				<div class="input-container">
				...
				<div class="footer">
					<a href='delete.do?id=${member.id}' class='button2'>탈퇴하기</a>
				</div>
			</form>
		</div>
	</div>
...
.button1:hover {
	...
	text-shadow: #ffffff 0 1px 0;
	background: #f3ff99;
	background: -webkit-gradient(linear, left top, left bottom, from(#b2ffd6),
		to(#f3ff99));
...
.button1:active {
	...
	background: #ffffff;
	background: -webkit-gradient(linear, left top, left bottom, from(#a6bdcc),
		to(#f3ff99));
