					...
					<div class="form_settings">
						<p>
							...
							<textarea class="contact textarea" rows="5" cols="50"
								name="content">${album.content}</textarea>
						</p>
						<p>
							<span>Photo</span>
							<input type="file" onchange="previewImage(this)" name="photofile" value="${album.photo}">
							<c:if test="${not empty album.photo}">
      <div class="rerun"><a href="../file/${album.photo}">${album.photo}</a></div></c:if>
						</p>
