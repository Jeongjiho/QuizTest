...
<body>
	<div id="main">
		...
		<form style="margin-left: 60%; margin-top: -3%" class="form-inline" action="login.do" method="post">
			...
			<button type="submit" class="btn btn-default" style="margin-right: 2%;  margin-top:2%;">Sign in</button>
			<button type="button" class="btn btn-default" style="margin-top:2%;">New Join</button>
		</form>
		...
		<div id="site_content">
			<ul class="slideshow">
				...
				<li><img width="950" height="450" src="http://cfile7.uf.tistory.com/image/2762F33D5172B19E043783"
					alt="&quot;It is the greatest invention in the world is just the heart of a child - Thomas Alva Edison -&quot;" /></li>
				<li><img width="950" height="450" src="http://cfile226.uf.daum.net/image/173B31044CF68D44025B69"
